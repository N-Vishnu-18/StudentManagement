...
function App() {
  ...
  const loadStudents = async () => {
    const res = await fetch("http://localhost:5050/getallstudents");
  ...
  const createStudent = async (e) => {
    e.preventDefault();
    await fetch("http://localhost:5050/createstudent", {
      method: "POST",
  ...
  const editStudent = async (e) => {
    e.preventDefault();
    await fetch(`http://localhost:5050/updatestudent/${editData.rollno}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
  ...
  const deleteStudent = async (e) => {
    e.preventDefault();
    await fetch(`http://localhost:5050/deletestudent/${deleteRoll}`, {
      method: "DELETE",
    });
    setDeleteRoll("");
    loadStudents();
